...
export const TrophyIcon = () => (
  <svg viewBox="0 0 1024 1024" width="20px" height="20px" version="1.1">
    ...
    <path
      d="M609.7 796.8H414.3v-61.2c0-11.5 9.4-20.9 20.9-20.9h153.7c11.5 0 20.9 9.4 20.9 20.9v61.2z"
      fill="#FFCA28"
    />
    <path
    ...
    />
    <path
      d="M257.2 115.8v284.8c-83.8-11.7-148.5-83.8-148.5-170.8v-114h148.5m52.2-52.2H98.2c-23.1 0-41.8 18.7-41.8 41.8v124.5C56.4 354 157 454.6 281.1 454.6h28.3v-391zM915.3 115.8v108.8c0 88-64.4 161.3-148.5 175.2v-284h148.5m10.5-52.2H714.6v390.9h23.1c126.9 0 229.8-102.9 229.8-229.8V105.4c0.1-23.1-18.7-41.8-41.7-41.8z"
      fill="#FFB300"
    />
    <path
